...
# Project:  nn.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile nn.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = nn1.0.0
DISTDIR = /home/javlik/qtws/nn/.tmp/nn1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -lSDL2   
AR            = ar cqs
...
Makefile: nn.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
ga.o: ga.c ga.h \
		nn.h \
		utils.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o ga.o ga.c

nn.o: nn.c nn.h \
		show.h \
		utils.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o nn.o nn.c

show.o: show.c show.h
	$(CC) -c $(CFLAGS) $(INCPATH) -o show.o show.c
